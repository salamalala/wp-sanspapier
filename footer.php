...
?>
    ...
    <footer class="footer" role="contentinfo">
      <div class="footer__content">
        ...
        <div class="footer__contact">
          ...
          <ul class="footer__social-media-icons">
            <li class="footer__social-media-icon">
              <svg class="footer__svg fb-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
            ...
            <li class="footer__social-media-icon">
              <svg class="footer__svg twitter-icon" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        ...
        <h5 class="footer__impressum">© 2016 Sanspapier Beratungsstelle Bern | Konzeption und Umsetzung <a class="" href="http://www.ninaregli.com/">Nina Regli </a> | <a href="<?php bloginfo('url'); ?>/impressum.php">Impressum</a></h5>
